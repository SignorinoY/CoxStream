...
#'
#' @param x A summary object produced from a fitted \code{coxens} model. This
...
#' @param ... Unused.
#' @return The function prints the summary of the \code{coxens} model and
...
print.summary.coxstream <- function(
  ...
  q <- x$degree + 1
  printCoefmat(x$coefficients[(q + 1):nrow(x$coefficients), ],
